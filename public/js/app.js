...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_numeric__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_CreateItem_vue__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_DisplayItem_vue__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_EditItem_vue__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_users_Users_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_users_Users_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__components_users_Users_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_users_EditUser_vue__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_users_EditUser_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__components_users_EditUser_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_users_CreateUser_vue__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_users_CreateUser_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__components_users_CreateUser_vue__);



__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_numeric___default.a);
...
var routes = [{
    ...
    name: 'UsersList',
    path: '/users/',
    component: __WEBPACK_IMPORTED_MODULE_9__components_users_Users_vue___default.a
}, {
    name: 'UserCreate',
    path: '/users/create',
    component: __WEBPACK_IMPORTED_MODULE_11__components_users_CreateUser_vue___default.a
}, {
    name: 'UserEdit',
    path: '/users/edit',
    component: __WEBPACK_IMPORTED_MODULE_10__components_users_EditUser_vue___default.a
}];
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_numeric__ = __webpack_require__(63);
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("i", { staticClass: "glyphicon glyphicon-fast-backward" }),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetch: function fetch() {
            ...
            var uri = 'http://localhost:8000/api/users/list';
            this.axios.get(uri).then(function (response) {
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass: "btn btn-primary",
                    attrs: { to: { name: "UserEdit", params: { id: user.id } } }
                  },
                  [
                    _c("i", { staticClass: "glyphicon glyphicon-pencil" }),
                    _vm._v(" Editar")
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0c114513", Component.options)
  } else {
    hotAPI.reload("data-v-0c114513", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUser: function getUser() {
            ...
            var uri = 'http://localhost:8000/api/users/' + this.$route.params.id + '/edit';
            this.axios.get(uri).then(function (response) {
        ...
        updateUser: function updateUser() {
            ...
            var uri = 'http://localhost:8000/api/users/' + this.$route.params.id + '/edit';
            this.axios.put(uri, this.user).then(function (response) {
                _this2.$router.push({ name: 'UsersList' });
            });
        }
    }
});
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h1", [_vm._v("Atualizar dados do Usuário")]),
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-10" }),
      _vm._v(" "),
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass: "btn btn-success",
              attrs: { to: { name: "VzUsers" } }
            },
            [
              _c("i", { staticClass: "glyphicon glyphicon-fast-backward" }),
              _vm._v(" Retornar a lista de usuários")
            ]
          )
        ],
        1
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "form-group" }, [
          _c("label", [_vm._v("Nome do Usuário")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { name: "product_price" } }, [_vm._v("E-mail")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0c114513", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/users/CreateUser.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-140106f6", Component.options)
  } else {
    hotAPI.reload("data-v-140106f6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        createUser: function createUser() {
            ...
            var uri = 'http://localhost:8000/api/users/create';
            this.axios.post(uri, this.user).then(function (response) {
                console.log(response);
                _this.$router.push({ name: 'UsersList' });
            });
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-140106f6", module.exports)
  }
}
